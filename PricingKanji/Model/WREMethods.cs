...
namespace PricingKanji.Model
{
    class WREMethods
    {
            ...
            // import WRE dlls
            [DllImport(@"C:\Users\Amine\Downloads\wre-ensimag-c-4.1.dll", EntryPoint = "WREmodelingCov", CallingConvention = CallingConvention.Cdecl)]
            // declaration
            ...
            [DllImport(@"C:\Users\Amine\Downloads\wre-ensimag-c-4.1.dll", EntryPoint = "WREmodelingLogReturns", CallingConvention = CallingConvention.Cdecl)]
            public static extern int WREmodelingLogReturns(
                ...
                ref int info);
            [DllImport(@"C:\Users\Amine\Downloads\wre-ensimag-c-4.1.dll", EntryPoint = "WREmodelingCorr", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(@"C:\Users\Amine\Downloads\wre-ensimag-c-4.1.dll", EntryPoint = "WREanalysisExpostVolatility", CallingConvention = CallingConvention.Cdecl)]
