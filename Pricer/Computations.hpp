...
namespace Computations {
	...
	MonteCarlo * initialize_mc(int nb_samples, double T, double past_[], double netAssetValue, double inital_values[], double nb_dates, double sigma_[], double correlation[], double r);
