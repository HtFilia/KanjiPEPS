...
namespace Computations {
	...
	DLLEXP void performance_price_t(double & ic, double & prix,int nb_samples, double T, double t, double past_[], double nb_dates, double sigma_[], double correlation[], double r);
	DLLEXP void performance_delta_t(double ic_deltas[], double deltas[], int nb_samples, double T, double t, double past_[], double nb_dates, double sigma_[], double correlation[], double r);
