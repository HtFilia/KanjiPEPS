...
void Computations::performance_price_t(double &ic, double &prix, int nb_samples, double T,
...
void Computations::performance_delta_t(double ic_deltas[], double deltas[], int nb_samples, double T,
	double t, double past_[], double nb_dates, double sigma_[], double correlation[], double r)
{
	int size = 3;
